...
st.markdown(
    ...
    <style>
    .stApp {{
        background-image: url('https://png.pngtree.com/thumb_back/fh260/background/20220306/pngtree-summary-inscription-on-notebook-page-corporate-document-text-photo-image_3581031.jpg'); /* Replace YOUR_IMAGE_URL with the direct link to your image */
